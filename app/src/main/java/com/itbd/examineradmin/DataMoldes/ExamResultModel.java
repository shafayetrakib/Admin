...
public class ExamResultModel {
    ...
    public ExamResultModel(String examName, String examDate, String examTotalMarks, String examResult, String userCourse, String userEmail, String userName, String userId) {
